...
int main()
{
    ...
    else
    {
        ...
        for(int i=11;i<n;i++)
        {
            for(int i=0;i<10;i++)
                brr[i]=arr[i];
            sort(brr,brr+10,compare);
            if(brr[9].fi==2)
            {
                arr[brr[9].fi].se={arr[brr[9].fi].se.se,arr[brr[9].fi].se.se+cnt};
                cnt++;
            }
            else
            {
                arr[brr[9].fi].se={arr[brr[9].fi].se.fi+1,arr[brr[9].fi].se.se+1};
            }
        }
        for(int i=0;i<10;i++)
        {
