...
int main()
{
    ...
    for(int i=1;i<=n;i++)
    {
        ...
        if(i>1)
        {
            ll temp=(cnt.query(1,0,200000,0,a-1)*a)-num.query(1,0,200000,0,a-1);
            temp%=MOD;
            temp+=num.query(1,0,200000,a+1,200000)-(cnt.query(1,0,200000,a+1,200000)*a);
            res*=temp%MOD;
            res%=MOD;
        }
        num.update(1,0,200000,a,(num.query(1,0,200000,a,a)+a));
        cnt.update(1,0,200000,a,cnt.query(1,0,200000,a,a)+1);
    }
    cout<<res;
}
